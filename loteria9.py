...
# =========================
# 1) CONFIGURAÇÃO DO MODELO (NOVA COLUNA: 2..50)
# =========================

states = ["A", "B", "C"]

# Proporções observadas (aprox.) nesta nova coluna
p0 = {"A": 0.32, "B": 0.45, "C": 0.23}

# Matriz de transição (Markov) (aprox.) nesta nova coluna
T = {
    "A": {"A": 0.36, "B": 0.50, "C": 0.14},
    "B": {"A": 0.29, "B": 0.46, "C": 0.25},
    "C": {"A": 0.33, "B": 0.41, "C": 0.26},
}

# Emissões (valores dentro de cada grupo) — média e desvio (aprox.)
means = {"A": 9.1, "B": 18.7, "C": 34.2}
stds  = {"A": 3.5, "B": 4.6, "C": 6.8}

# Limites observados na nova coluna
MIN_VAL, MAX_VAL = 2, 50
...
def classify_value(v):
    """Classificação (nova coluna): A=2..12, B=13..25, C=26..50."""
    if v <= 12:
        return "A"
    elif v <= 25:
        return "B"
